...
dfst <- df %>% select(rate,X1,Time, numero_episodio) %>% as_tsibble(key=X1)
training <- dfst %>% filter(numero_episodio <=400)
test <- dfst %>% filter(numero_episodio >400)
