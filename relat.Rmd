...
Além dos testes acima também podemos buscar uma confirmação visual de que os modelos são adequados assim iremos usar a autocorrelação parcial para corroborar com o que mostrado pelos testes:
