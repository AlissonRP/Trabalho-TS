...
model_work1 <- workflow_set(
  ...
  models  = list(
    ...
    M_smooth_etsAANN = smooth_etsAANN,
    M_smooth_etsAAND = smooth_etsAAND,
    M_smooth_etsAAAN = smooth_etsAAAN,
    M_smooth_etsAAAD = smooth_etsAAAD,
    M_smooth_etsAAMN = smooth_etsAAMN,
    M_smooth_etsAAMD = smooth_etsAAMD,
    M_smooth_etsAMNN = smooth_etsAMNN,
    M_smooth_etsAMND = smooth_etsAMND,
    M_smooth_etsAMAN = smooth_etsAMAN,
    M_smooth_etsAMAD = smooth_etsAMAD,
    M_smooth_etsAMMN = smooth_etsAMMN,
    M_smooth_etsAMMD = smooth_etsAMMD,
    M_smooth_etsMNN = smooth_etsMNN,
    M_smooth_etsMNA = smooth_etsMNA,
    M_smooth_etsMNM = smooth_etsMNM,
    M_smooth_etsMANN = smooth_etsMANN,
    M_smooth_etsMAND = smooth_etsMAND,
    M_smooth_etsMAAN = smooth_etsMAAN,
    M_smooth_etsMAAD = smooth_etsMAAD,
    M_smooth_etsMAMN = smooth_etsMAMN,
    M_smooth_etsMAMD = smooth_etsMAMD,
    M_smooth_etsMMNN = smooth_etsMMNN,
    M_smooth_etsMMND = smooth_etsMMND,
    M_smooth_etsMMAN = smooth_etsMMAN,
    M_smooth_etsMMAD = smooth_etsMMAD,
    M_smooth_etsMMMN = smooth_etsMMMN,
    M_smooth_etsMMMD = smooth_etsMMMD
  ),
  cross   = TRUE
)
...
model_metrics1 <- modeltime_wfs_rank(model_fit1,
                              rank_metric = "rsq", minimize = FALSE)
model_metrics1 %>%
  select(-`.fit_model`) %>%
  mypdf1::pdf1_tbl("Métricas")
```
